...
const Dashboard: React.FC<DashboardProps> = ({ profile, sales, onViewHistory }) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-6 duration-700 relative pb-10">
      <header className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <button 
            ...
            className="w-10 h-10 rounded-xl glass flex items-center justify-center text-green-500 active:scale-90 transition-all shadow-sm"
          >
      ...
      <div className="flex p-1 bg-gray-500/10 rounded-2xl">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className={`ios-card shadow-xl text-white ${viewScope === 'my' ? 'bg-gradient-to-br from-blue-600 to-indigo-700 shadow-blue-500/20' : 'bg-gradient-to-br from-orange-600 to-red-700 shadow-orange-500/20'}`}>
        ...
        <div className="ios-card glass shadow-lg">
          ...
          {calendarDays.map((date, i) => {
            ...
            return (
              <div 
                ...
                className={`aspect-square relative rounded-xl flex items-center justify-center text-xs font-black transition-all cursor-pointer ${isSelected ? 'ring-2 ring-blue-500 scale-105 z-10 bg-blue-600/10' : bgColor} ${isSelected ? 'text-white' : textColor}`}
              >
      ...
      <div 
        ...
        className="ios-card glass cursor-pointer active:scale-[0.98] transition-all bg-gradient-to-r from-[var(--accent)]/5 to-transparent flex justify-between items-center"
      >
        <div>
      ...
      {showDayReportCard && (
        <div className="fixed inset-0 z-[2000] flex items-center justify-center p-6 animate-in fade-in zoom-in-95 duration-300">
          ...
          <div className="relative w-full max-w-sm bg-[#050505] rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(255,149,0,0.15)] flex flex-col max-h-[85vh]">
            <div className={`p-8 text-white relative border-b border-white/5 ${viewScope === 'my' ? 'bg-gradient-to-br from-blue-900/40 to-black' : 'bg-gradient-to-br from-orange-900/40 to-black'}`}>
               ...
               <button 
                  onClick={copyWhatsAppReport}
                  className="mt-6 w-full py-4 bg-green-600 rounded-xl font-black text-[10px] uppercase tracking-widest shadow-[0_10px_30px_rgba(34,197,94,0.3)] flex items-center justify-center space-x-2 active:scale-95 transition-all"
               >
