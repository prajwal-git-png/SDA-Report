...
const HistoryView: React.FC<HistoryViewProps> = ({ sales, profile, onDelete, onEdit }) => {
                ...
                {groupedByDate[date].map((sale: SaleEntry) => (
                  <div key={sale.id} className="ios-card flex flex-col space-y-3 group transition-all duration-300 active:scale-[0.98]">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex space-x-2 opacity-20 group-hover:opacity-100 transition-opacity">
                        <button 
                          onClick={() => onEdit(sale)}
